...
export default function MachinesTest(props) {
  ...
  const loadModalData = (item) => {
    setModalData({
      id: item.id,
      subclassType: item.subclassType,
  ...
  const addClassItem = () => {
    if (classItem.classType == "") {
      setClassItemErrors((history) => ({
        ...history,
        subclassTypeeError: "* Please enter the Subclass",
      }));
  ...
  const removeItem = (index) => {
    setClassData(classData.filter((a) => a.id !== index));
  };
        ...
        <Col md="2" style={{ backgroundColor: "#F5F5F5", marginLeft: "20px" }}>
          ...
          <tr>
            <td>
              ...
              >
                <TiPlus style={{ fontFamily: "initial", color: "green" }} /> Add
                New Subclass
              </Label>
            </td>
          </tr>
          ...
          <tr>
            <td>
              ...
              />
              {classItemErrors.subclassTypeeError.length > 0 ? (
                <p style={{ color: "red", fontFamily: "initial" }}>
          ...
          <tr>
            <td>
              ...
              />
              {classItemErrors.descriptionError.length > 0 ? (
                <p style={{ color: "red", fontFamily: "initial" }}>
        ...
        <Col md="7" style={{ marginLeft: "2%", marginTop: "1px" }}>
          ...
          >
            <Table striped hover>
              ...
              <tbody>
                {subclassData != null && subclassData.length > 0 ? (
                  subclassData.map((item, index) => {
                    const rowClass =
                    ...
                    return (
                      ...
                      >
                        <th
                          className="th1"
                          scope="row"
                          style={{ fontFamily: "initial", textAlign: "left" }}
                        >
                          {item.id}
                        </th>
                        <td
                  ...
                  <tr>
                    <td
                      ...
                      style={{ fontFamily: "initial", color: "red" }}
                    >
