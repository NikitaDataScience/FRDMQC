...
export default function SourceDataValidation() {
  ...
  const [statsdata, setstatsdat] = useState("");
  ...
  const [machineDDLValue, setMachineDDLValue] = React.useState(1);
 ...
 const loadStats = (selectedMachineId) => {
  ...
  axios.request(config)
    .then(result => {
      console.log("Validation Stats Data : ",result.data);
  ...
  const handleMachineDropdownChange = (event) => {
    const selectedMachineId = event.target.value;
    setMachineDDLValue(selectedMachineId); // Optionally, you can keep this if needed
    setMachineID(selectedMachineId); // Update the MachineID state
    // Optionally, you can call loadStats here with the selectedMachineId
    loadStats(); // If you want to load stats when the machine selection changes
  }
...
<div className='row'>
      ...
      <div className='row' >
        <Col sm={2} style={{ width: "900", borderColor: 'green', marginTop: "54px", overflow: "scroll",  marginTop: "-110px", height: "1000", marginLeft: "10px", marginBottom: "20px" }}>
        ...
        <Col >
          ...
          <div className='col-md-8'>
            <div style={{
               height: 420, backgroundColor: '#fff', overflow: "scroll", position: "sticky", marginTop: "10px", width: "108%",
              marginLeft: "10px"
            }}>
