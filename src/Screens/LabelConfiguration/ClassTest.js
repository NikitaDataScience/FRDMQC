...
export default function ClassTest(props) {
    ...
    return (
        ...
        <div style={{ backgroundColor: "#F5F5F5", height: "100%", margin: 0, position: "fixed", width: "100%" }}>
            <Row>
                <Col md="2" style={{ backgroundColor: "#F5F5F5", marginLeft: "10px", marginTop: "50px" }}>
                    {/* <Card style={{ marginBottom: "50px", borderColor: 'green', marginTop: "50px" }}>
                        <CardBody> */}
                    ...
                    <tr>
                        <td >
                            <Label
                                for="classes"
                                style={{ fontFamily: "initial", color: "black", marginTop: "20px", marginLeft: "20px", marginRight: "40px" }}
                            >
                                Select Machine Name :
                            </Label>
                        </td>
                ...
                <Col md="7" style={{ marginLeft: "2%", marginTop: "1px" }}>
                    ...
                    >
                        {console.info('Show Progress Value: ' + ShowProgress)}
                        {ShowProgress ? <Container><Spinner color="primary">
                            Loading...
                        </Spinner> </Container> : <></>}
                                ...
                                {classData != null && classData.length > 0 ? classData.map((item, index) => {
                                    ...
                                    return (
                                        <tr tr className="table-warning" key={index} onClick={() => rowClick(index)}>
                                            <th scope="row" style={{ fontFamily: "initial", backgroundColor: "white", textAlign: "left" }}>
                                                {item.id}
                                            </th>
                                            ...
                                            {/* <td style={{ fontFamily: "initial", backgroundColor: "white", textAlign: "center" }}>
                                                <a color="navy" size="sm" href={`subclasstest?id=${item.id}&machinestestId=${MachineID}`} style={{ fontFamily: "initial" }} >
